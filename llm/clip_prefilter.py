...
# runs transformers' docstring decorators, which also call inspect.getsource on
# optimum/transformers modules. The build therefore ships those packages WITH their
# .py sources — see packaging/pyinstaller-hooks/ (module_collection_mode "pyz+py").
